...
const sheetGID = "0"; // Ganti sesuai sheet yang diinginkan
...
async function fetchSpreadsheet() {
    try {
        ...
        const dataContainer = document.getElementById("uts-container"); //harus disamakan dengan container pada html
